...
EpcX2RlcSetupRequestHeader::Serialize (Buffer::Iterator start) const
{
  ...
  i.WriteHtonU16 (m_secondaryRnti); 
  i.WriteHtonU16 (m_masterRnti);
  i.WriteU8 (m_drbid);
...
EpcX2RlcSetupRequestHeader::Deserialize (Buffer::Iterator start)
{
  ...
  m_secondaryRnti = i.ReadNtohU16 ();
  m_headerLength += 2;
  m_numberOfIes++;

  m_masterRnti = i.ReadNtohU16 ();
  m_headerLength += 2;
  m_numberOfIes++;
...
EpcX2RlcSetupRequestHeader::Print (std::ostream &os) const
{
  ...
  os << " SecondaryRnti = " << m_secondaryRnti;
  os << " MasterRnti = " << m_masterRnti;
...
void
EpcX2RlcSetupRequestHeader::SetSecondaryRnti (uint16_t rnti)
{
  m_secondaryRnti = rnti;
}

uint16_t
EpcX2RlcSetupRequestHeader::GetSecondaryRnti () const
{
  return m_secondaryRnti;
}

void
EpcX2RlcSetupRequestHeader::SetMasterRnti (uint16_t rnti)
{
  m_masterRnti = rnti;
}

uint16_t
EpcX2RlcSetupRequestHeader::GetMasterRnti () const
{
  return m_masterRnti;
}
