...
#ifndef NI_GFDM_RR_FF_MAC_SCHEDULER_H
#define NI_GFDM_RR_FF_MAC_SCHEDULER_H
...
class NiGfdmRrFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NiGfdmRrFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NiGfdmRrFfMacScheduler ();
  ...
  friend class NiGfdmRrSchedulerMemberCschedSapProvider;
  friend class NiGfdmRrSchedulerMemberSchedSapProvider;
...
#endif /* NI_GFDM_RR_FF_MAC_SCHEDULER_H */
