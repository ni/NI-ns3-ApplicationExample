...
#include "ns3/ni-gfdm-rr-ff-mac-scheduler.h"
#include "ns3/ni-logging.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("NiGfdmRrFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NiGfdmRrFfMacScheduler);


class NiGfdmRrSchedulerMemberCschedSapProvider : public FfMacCschedSapProvider
{
public:
  NiGfdmRrSchedulerMemberCschedSapProvider (NiGfdmRrFfMacScheduler* scheduler);
...
private:
  NiGfdmRrSchedulerMemberCschedSapProvider ();
  NiGfdmRrFfMacScheduler* m_scheduler;
};

NiGfdmRrSchedulerMemberCschedSapProvider::NiGfdmRrSchedulerMemberCschedSapProvider ()
{
}

NiGfdmRrSchedulerMemberCschedSapProvider::NiGfdmRrSchedulerMemberCschedSapProvider (NiGfdmRrFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
NiGfdmRrSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
NiGfdmRrSchedulerMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
NiGfdmRrSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
NiGfdmRrSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
NiGfdmRrSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
...
class NiGfdmRrSchedulerMemberSchedSapProvider : public FfMacSchedSapProvider
{
public:
  NiGfdmRrSchedulerMemberSchedSapProvider (NiGfdmRrFfMacScheduler* scheduler);
...
private:
  NiGfdmRrSchedulerMemberSchedSapProvider ();
  NiGfdmRrFfMacScheduler* m_scheduler;
};



NiGfdmRrSchedulerMemberSchedSapProvider::NiGfdmRrSchedulerMemberSchedSapProvider ()
{
}


NiGfdmRrSchedulerMemberSchedSapProvider::NiGfdmRrSchedulerMemberSchedSapProvider (NiGfdmRrFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
NiGfdmRrSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
int
roundToNextMultiple(int numToRound, int multipleof)
{
    if (numToRound == 0){
      numToRound=4;
    }
    ...
    if (remainder == 0 && numToRound >! 20)
        return numToRound;

    return numToRound + multipleof - remainder;
}

NiGfdmRrFfMacScheduler::NiGfdmRrFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new NiGfdmRrSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new NiGfdmRrSchedulerMemberSchedSapProvider (this);
}
...
void
NiGfdmRrFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NiGfdmRrFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NiGfdmRrFfMacScheduler")
    .SetParent<FfMacScheduler> ()
    .SetGroupName("Lte")
    .AddConstructor<NiGfdmRrFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NiGfdmRrFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NiGfdmRrFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NiGfdmRrFfMacScheduler::m_ulGrantMcs),
...
void
NiGfdmRrFfMacScheduler::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NiGfdmRrFfMacScheduler::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
NiGfdmRrFfMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
NiGfdmRrFfMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NiGfdmRrFfMacScheduler::SetLteFfrSapProvider (LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

LteFfrSapUser*
NiGfdmRrFfMacScheduler::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NiGfdmRrFfMacScheduler::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
NiGfdmRrFfMacScheduler::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
...
void
NiGfdmRrFfMacScheduler::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
NiGfdmRrFfMacScheduler::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NiGfdmRrFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
bool
NiGfdmRrFfMacScheduler::SortRlcBufferReq (FfMacSchedSapProvider::SchedDlRlcBufferReqParameters i,FfMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
uint8_t
NiGfdmRrFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NiGfdmRrFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NiGfdmRrFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  uint32_t gfdmRbgMask = 0xffc3ff; //b0111111111100001111111111
  const uint32_t gfdmNumMiddleBits = 4;
  int gfdmRbgNum = 25 - gfdmNumMiddleBits - 1; //20. Represented are the 4 middle PRBs being extracted and the first one. Multiple of 4 needed for GFDM
  const int gfdmRbgSize = 4; //4 for 20Mhz
  ...
  //int rbgSize = gfdmRbgSize;
  int rbgNum = m_cschedCellConfig.m_dlBandwidth / rbgSize;
  //int rbgNum = gfdmRbgNum;
  ...
  if (rbgPerTb == 0)
    {
      rbgPerTb = 1;                // at least 1 rbg per TB (till available resource)
          ...
          //round MAC Scheduler decision to next multiple of 4 and assign it to auxiliary
        gfdmRbgNum = roundToNextMultiple(rbgPerTb,4);
        //Truncates the result to 20 as anything higher will not comply to the GFDM constraints.
        if (gfdmRbgNum > 20){
          gfdmRbgNum = 20;
        }

        if (nflows != 1){
          NI_LOG_FATAL(this << "System designed for only one user and one layer. Please correct settings.");
        }
        else{
        //switch that does the appropriate setup for the MAC scheduler based on the rounding result
        switch (gfdmRbgNum){
          case 4: {
            gfdmRbgMask = 0x00000f;
            rbgPerTb=gfdmRbgNum;
            rbgNum=gfdmRbgNum;
            rbgAllocatedNum=gfdmRbgNum;
            break;
          }
          case 8: {
            gfdmRbgMask = 0x0000ff;
            rbgPerTb=gfdmRbgNum;
            rbgNum=gfdmRbgNum;
            rbgAllocatedNum=gfdmRbgNum;
            break;
          ...
          default:{
            NI_LOG_FATAL(this << "Invalid MAC scheduler detected. Program terminated.");
            break;
          }
        }
      }
//      printf("The GFDM MAC Scheduler Output has %d RBGs allocated and 0x%08x as a mask. \n ", rbgNum, gfdmRbgMask);
        //End of Switch
...
//      printf("rbgMask 0x%08x \n", rbgMask);
      newDci.m_rbBitmap = gfdmRbgMask;
      //std::cout << "gfdmsched:" << gfdmRbgMask << std::endl;
...
void
NiGfdmRrFfMacScheduler::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
NiGfdmRrFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NiGfdmRrFfMacScheduler::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NiGfdmRrFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
          ...
          if (it == m_ceBsrRxed.end ())
            {
              ...
              NI_LOG_DEBUG("NiGfdmRrFfMacScheduler::DoSchedUlMacCtrlInfoReq: Insert RNTI " << rnti << " queue " << buffer);
            }
          else
            {
              ...
              NI_LOG_DEBUG("NiGfdmRrFfMacScheduler::DoSchedUlMacCtrlInfoReq: Update RNTI " << rnti << " queue " << buffer);
            }
        }
    }
...
void
NiGfdmRrFfMacScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NiGfdmRrFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NiGfdmRrFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NiGfdmRrFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
NiGfdmRrFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
  ...
  if (it != m_ceBsrRxed.end ())
    {
      ...
      NI_LOG_DEBUG ("NiGfdmRrFfMacScheduler::UpdateUlRlcBufferInfo: Update RLC BSR UE " << rnti << " size " << size << " BSR " << (*it).second);
      if ((*it).second >= size)
        {
          (*it).second -= size;
        }
...
void
NiGfdmRrFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
