...
namespace gregorian {
  ...
  std::tm to_tm(const date& d)
  {
    ...
    datetm.tm_year = ymd.year - (boost::gregorian::greg_year)1900;
    datetm.tm_mon = ymd.month - (boost::gregorian::greg_month)1;
    datetm.tm_mday = ymd.day;
    datetm.tm_wday = d.day_of_week();
    datetm.tm_yday = d.day_of_year() - (boost::gregorian::date::day_of_year_type)1;
