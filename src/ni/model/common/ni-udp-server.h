...
#ifndef NI_UDP_SERVER_H
#define NI_UDP_SERVER_H
 ...
 * \defgroup niudpclientserver NiUdpClientServer
 */

/**
 * \ingroup niudpclientserver
 *
 ...
 */
class NiUdpServer : public Application
{
public:
  /**
